...
children.push(para("Jaccard 계수: J(A, B) = |A ∩ B| / |A ∪ B|. 예: 코더 1 {SDG7, SDG1}, 코더 2 {SDG7} → J = 1/2 = 0.5"));
...
children.push(bullet("코더 간 주목표가 다른 케이스, 또는 연계목표 집합이 Jaccard < 0.5인 케이스를 추출합니다."));
...
children.push(bullet("② IAA 산출 시 HOLD 케이스는 제외. HOLD 비율은 코더별로 별도 집계."));
